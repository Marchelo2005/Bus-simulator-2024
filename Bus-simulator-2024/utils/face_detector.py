...
class Detector:
    ...
    def face():
        ...
        cap = cv2.VideoCapture(f"video/{Detector.txtVideo}{randomVideo}.mp4")
        GREEN = (0, 255, 0)
        YELLOW = (0, 255, 255)
        ...
        while True:
            ...
            for detection in detections[0][0]:
                if detection[2] > 0.5:
                    ...
                    cv2.rectangle(frame, (x_start, y_start), (x_end, y_end), GREEN, 2)
                    cv2.putText(frame, f"Conf: {detection[2] * 100:.2f}%", (x_start, y_start - 5), cv2.FONT_HERSHEY_SIMPLEX, 0.5, YELLOW, 2)
            ...
            screenVideo.blit(frame_surface, (0, 0))
            pygame.display.flip()
